"""Generate web-optimized images for faster biodata loading."""
...
GALLERY = [
    ...
    "DSC01229.jpg", "DSC01236.jpg", "DSC01239.jpg",
    "DSC01521.jpg", "DSC01530.jpg", "DSC01570.jpg",
]
...
def make_profile() -> None:
    img = Image.open(SRC / "Image4.jpeg")
    img = ImageOps.exif_transpose(img)
    w, h = img.size
    side = min(w, h)
    # Center crop on upper-body / face (original has extra headroom)
    face_y = int(h * 0.58)
    top = face_y - side // 2
